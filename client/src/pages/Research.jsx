  ...
  return (
    <div>
        ...
        <div className="mb-4 mt-4 flex flex-col mx-4">
          <SearchBar className="mb-4 mt-4 items-center justify-center mx-4"/>
        </div>
            <div className='flex mb-4 mt-4 mx-2'>
                ...
                {/* <Card className="w-1/4 mx-2 bg-[#EBFBFF] p-2 flex flex-col">
                    <div className=''>Till 2016</div>
                    <div className="text-6xl font-bold justify-center items-center my-5">02</div>
                    <CardContent>Journals</CardContent>
                </Card> */}
